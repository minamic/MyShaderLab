...
Shader "Custom/NightVisionEffect" 
{
	Properties 
	{
		...
		_NoisYSpeed ("Noise Y Speed", Float) = 100.0
		_ScanLineTileAmount ("Scan Line Tile Amount", Float) = 4.0
		_NightVisionColor ("Night Vision Color", Color) = (1.0, 1.0, 1.0, 1.0)
	...
	SubShader 
	{
	    Pass
	    {
	        ...
	        fixed4 frag(v2f_img i) : COLOR
	        {
	            ...
	            //get luminosity values from the render texture using the YIQ values.
